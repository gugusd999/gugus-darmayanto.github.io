//Generated:2020-11-20 18:57:37// 6-243
(function() {
  var o = {
    $: function(el) {
      var x = el || o.divID,
  ...
  var data = {
    params: window.ftParams_5139417 || '',
    guid: window.ftGUID_5139417 || '',
    confID: window.ftConfID_5139417 || '0',
    ftReturn: window.ftReturn_5139417 || '',
    keyword: window.ftKeyword_5139417 || '',
    ftId: window.ftId_5139417 || '',
    ftImpId: window.ftImp5139417 && window.ftImp5139417.impID || '',
    gdpr: window.ftImp5139417 && window.ftImp5139417.gdpr || '',
    gdpr_consent: window.ftImp5139417 && window.ftImp5139417.gdpr_consent || '',
    gdpr_pd: window.ftImp5139417 && window.ftImp5139417.gdpr_pd || '',
    us_privacy: window.ftImp5139417 && window.ftImp5139417.us_privacy || '',
    campaignID: '140271',
    cID: '134058',
    pID: '5139417',
    creativeID: '3268877',
    ...
    clickTags: ['http://servedby.flashtalking.com/click/8/140271;5139417;3268877;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://inteliot.force.com/DevcloudForEdge/s/?cid=diad&source=stack_display_caf&campid=ww_q4_iotg_devcloud&content=comms-reg_all'],
    statBaseURL: 'http://stat.flashtalking.com/reportV3/ft.stat?194686383-5139417;3268877;',
    centreAd: false,
    width: 300,
    height: 250,
    adType: 'custom_rule'.toLowerCase(),
    altimg: 'http://cdn.flashtalking.com/xre/513/5139417/3268877/image/3268877.gif',
    viewableImpressionURL: 'http://servedby.flashtalking.com/imp/8/140271;5139417;202;pixel;StackOverflowUS;Rectangles/?',
    stump: 'http://servedby.flashtalking.com',
    altimghref: 'http://servedby.flashtalking.com/click/8/140271;5139417;3268877;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://inteliot.force.com/DevcloudForEdge/s/?cid=diad&source=stack_display_caf&campid=ww_q4_iotg_devcloud&content=comms-reg_all',
    divID: 'ftdiv5139417',
    altimgID: 'ftalt5139417',
    alttext: 'Click here',
    w: window,
    adDisplayed: false,
    customPos: false,
    ...
    append: !!(window.ftImp5139417 && parseInt(window.ftImp5139417.jsAppend, 10) === 1),
    ...
    secure: !!(location.protocol === 'https:' || /^https:/.test((document.getElementById('ftscript_m5139417') || {}).src) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc', ''))),
    scriptLocation: document.getElementById('ftscript_m5139417'),
    pageVisible: 'maybe',
