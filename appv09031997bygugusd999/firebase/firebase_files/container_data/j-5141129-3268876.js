//Generated:2020-11-20 18:57:41// 6-243
(function() {
  var o = {
    $: function(el) {
      var x = el || o.divID,
  ...
  var data = {
    params: window.ftParams_5141129 || '',
    guid: window.ftGUID_5141129 || '',
    confID: window.ftConfID_5141129 || '0',
    ftReturn: window.ftReturn_5141129 || '',
    keyword: window.ftKeyword_5141129 || '',
    ftId: window.ftId_5141129 || '',
    ftImpId: window.ftImp5141129 && window.ftImp5141129.impID || '',
    gdpr: window.ftImp5141129 && window.ftImp5141129.gdpr || '',
    gdpr_consent: window.ftImp5141129 && window.ftImp5141129.gdpr_consent || '',
    gdpr_pd: window.ftImp5141129 && window.ftImp5141129.gdpr_pd || '',
    us_privacy: window.ftImp5141129 && window.ftImp5141129.us_privacy || '',
    campaignID: '140271',
    cID: '134058',
    pID: '5141129',
    creativeID: '3268876',
    ...
    clickTags: ['http://servedby.flashtalking.com/click/8/140271;5141129;3268876;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://inteliot.force.com/DevcloudForEdge/s/?cid=diad&source=stack_display_caf&campid=ww_q4_iotg_devcloud&content=comms-reg_all'],
    statBaseURL: 'http://stat.flashtalking.com/reportV3/ft.stat?194686388-5141129;3268876;',
    centreAd: false,
    width: 728,
    height: 90,
    adType: 'custom_rule'.toLowerCase(),
    altimg: 'http://cdn.flashtalking.com/xre/514/5141129/3268876/image/3268876.gif',
    viewableImpressionURL: 'http://servedby.flashtalking.com/imp/8/140271;5141129;202;pixel;StackOverflowUS;Leaderboards/?',
    stump: 'http://servedby.flashtalking.com',
    altimghref: 'http://servedby.flashtalking.com/click/8/140271;5141129;3268876;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://inteliot.force.com/DevcloudForEdge/s/?cid=diad&source=stack_display_caf&campid=ww_q4_iotg_devcloud&content=comms-reg_all',
    divID: 'ftdiv5141129',
    altimgID: 'ftalt5141129',
    alttext: 'Click here',
    w: window,
    adDisplayed: false,
    customPos: false,
    ...
    append: !!(window.ftImp5141129 && parseInt(window.ftImp5141129.jsAppend, 10) === 1),
    ...
    secure: !!(location.protocol === 'https:' || /^https:/.test((document.getElementById('ftscript_m5141129') || {}).src) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc', ''))),
    scriptLocation: document.getElementById('ftscript_m5141129'),
    pageVisible: 'maybe',
